import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{c as u}from"./clsx-B-dksMZM.js";import{P as h}from"./Popover-PUBVhWLT.js";import{I as x}from"./Info-C8x1KHs8.js";import{L as g}from"./Label-DhsfTjoI.js";import{I as f}from"./Input-CipCtAz8.js";import"./index-yBjzXJbu.js";import"./index-DubqEmGm.js";import"./Portal-BD7l88-r.js";import"./index-CD8QLViS.js";import"./index-CJ88nXQk.js";import"./floating-ui.react-M7Gz8XYl.js";import"./useMergeRefs-CZnCAFkU.js";import"./SvgIcon-APGatIbJ.js";import"./useInputErrorMessages-oqpeSQgv.js";import"./Error-li26Yj3Y.js";import"./Flex-DxJ_lyQp.js";import"./IconButton-CW0ydAz1.js";import"./index-7zOkDzdb.js";import"./Tooltip-CkS6vPEG.js";import"./index-Cljcv3Ef.js";import"./Close-FGPrTY3A.js";const y="_hintButton_1mud9_1",v="_iconWrapper_1mud9_18",b="_content_1mud9_28",_="_arrow_1mud9_40",a={hintButton:y,iconWrapper:v,content:b,arrow:_},n=({placement:t="auto",ariaLabel:i="More information",width:l=245,positioning:c,children:d,className:m})=>e.jsx(h,{withArrow:!0,content:d,placement:t,classNames:{content:a.content,arrow:a.arrow},positioning:c,style:{width:l},children:e.jsx("span",{"aria-label":i,role:"button",tabIndex:0,className:u(a.hintButton,m),onClick:p=>{p.stopPropagation(),p.preventDefault()},children:e.jsx("span",{className:a.iconWrapper,children:e.jsx(x,{})})})});try{n.displayName="Hint",n.__docgenInfo={description:"",displayName:"Hint",props:{positioning:{defaultValue:null,description:"Sets the positioning of the Hint popover, uses the `Popover` defaults when not set.",name:"positioning",required:!1,type:{name:"enum",value:[{value:'"absolute"'},{value:'"fixed"'}]}},placement:{defaultValue:{value:"auto"},description:"Determines where the hint should appear relative to the hint icon.",name:"placement",required:!1,type:{name:"enum",value:[{value:'"top"'},{value:'"right"'},{value:'"bottom"'},{value:'"left"'},{value:'"top-start"'},{value:'"top-end"'},{value:'"right-start"'},{value:'"right-end"'},{value:'"bottom-start"'},{value:'"bottom-end"'},{value:'"left-start"'},{value:'"left-end"'},{value:'"auto"'}]}},width:{defaultValue:{value:"245"},description:"Changes the width of the hint.",name:"width",required:!1,type:{name:'number | "auto"'}},ariaLabel:{defaultValue:{value:"More information"},description:"Changes the accessibility label on the hint icon.",name:"ariaLabel",required:!1,type:{name:"string"}},children:{defaultValue:null,description:"Renders text content and / or any HTML node in the hint.",name:"children",required:!0,type:{name:"ReactNode | ((setVisible: (opened: boolean) => void) => ReactNode)"}},className:{defaultValue:null,description:"Sets the css class attribute.",name:"className",required:!1,type:{name:"string"}}}}}catch{}const A={title:"Components/Hint",component:n,parameters:{controls:{sort:"requiredFirst"},docs:{source:{excludeDecorators:!0},description:{component:`Hint can be used as an icon button to provide additional context and explanations for other UI elements or text.
