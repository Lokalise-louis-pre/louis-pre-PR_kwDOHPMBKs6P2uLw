...
[Figma Source File | Tag](https://www.figma.com/file/zfCOLmZam4nrttG6IVzQyz/Louis?node-id=4030%3A23309)`}}},argTypes:{onClick:{action:"clicked"}}},_={args:{children:"Default"}},S={args:{children:"Solid",variant:"solid"}},F={args:{children:"Outlined",variant:"outlined"},name:"Outline Tag"},B={args:{children:"Non-clickable Tag",onClick:void 0},name:"Non-clickable"},w={args:{children:"Default",size:"default"},name:"Normal size"},C={args:{children:"Small",size:"small"},name:"Small size"},W={args:{children:"Just a normal, long tag that's not affected in any way"},name:"With no ellipsis"},k={args:{children:"This is what happens when tag is very long",fullWidth:!0},render:u=>x.jsx("div",{style:{width:100,overflow:"hidden"},children:x.jsx(N,{...u,fullWidth:!0,children:u.children})}),name:"With ellipsis"};_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  args: {
    children: 'Default'
  }
  ...
  name: 'With ellipsis'
}`,...k.parameters?.docs?.source}}};const _e=["Default","Solid","Outline","NonClickable","NormalSize","SmallSize","WithNoEllipsis","WithEllipsis"];export{_ as Default,B as NonClickable,w as NormalSize,F as Outline,C as SmallSize,S as Solid,k as WithEllipsis,W as WithNoEllipsis,_e as __namedExportsOrder,Te as default};
